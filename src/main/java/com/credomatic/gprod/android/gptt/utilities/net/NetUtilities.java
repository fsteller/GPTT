 ...
 */
public class NetUtilities extends NetBase {

    private static final int SOCKET_TIMEOUT = 3000;
    private static final String TAG = NetUtilities.class.getSimpleName();
    ...
    private static URLConnection getConnection(final String url, final String method) {
        ...
        try {
            ...
            Log.d(TAG, "URL: " + url);
            final URL urlSpect = new URL(url);
            final URL aux = new URL(urlSpect.getProtocol(), urlSpect.getHost(),
                    urlSpect.getPort(), urlSpect.getFile());
