...
import com.credomatic.gprod.android.gptt.app.IActivity;
import com.credomatic.gprod.android.gptt.app.IFragmentService;
import com.credomatic.gprod.android.gptt.fragments.FragmentServiceHeader;
...
public class ActivityGPTT extends FragmentActivity implements IActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gtt);
    ...
    protected void onResume() {
        super.onResume();
        this.application = (AppGPTT) getApplication();
        if (application != null && !application.isHttpServiceRunning())
